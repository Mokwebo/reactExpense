...
const submitHandler = (event) => {
    ...
    const onCondition = () => {
        setFormOpen(!formOpened);
    }

    let content =  <div className="new-expense__actions"><button type="submit" onClick={onCondition}>Add Expense</button></div>
    ...
    return (
        <form onSubmit={submitHandler}>  
            ...
            <div className="new-expense__actions">
                <button type="submit" onClick={onCondition}>Cancel</button>
